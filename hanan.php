...
<html lang="en">
  <head>
    ...
    <title>Mayari | Featured - Hanan</title>
    <link
      rel="stylesheet"
...
<section id="header"> 
    ...
    <section id="prodetails" class="section-p1">
      <div class="single-pro-image">
        <img src="img/products/f1.jpg" width="100%" id="MainImg" alt="Hanan" />
      ...
      <div class="single-pro-details">
        ...
        <span>Show off this HANAN Glamorous Minimalist Chain Square Evening Bag, skillfully crafted by local artisans. Named after sister of MAYARI.</span>
        <table class="style">
        
          <tr>
            <th>COLOR(S):</th>
            <td style="background-color: gold; color: white;"> Gold </td>
            <td style="background-color: silver; color: white;"> Silver </td>
